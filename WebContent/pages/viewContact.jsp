...
Entreprise <input disabled="disabled" id="checkBoxEntreprise" type="checkbox" onclick="activeNumSiret()">
			...
			<bean:message key="label.contact.numSiret" />
				...
				<br>
				<html:text readonly="true" styleId="numSiretTextBox"  name="updateC" property="numSiret" size="20" maxlength="20" 
				...
				<html:text readonly="true" name="updateC" property="firstName" size="20"
				...
				<br>
				<html:text readonly="true" name="updateC" property="lastName" size="20"
					maxlength="20" styleClass="form-control" />
				<BR>
				<br>
				...
				<br>
				<html:text readonly="true" name="updateC" property="email" size="50" maxlength="50"
					styleClass="form-control" />
				<BR>
				<br>
				...
				<br>
				<html:text readonly="true" name="updateC" property="street" size="50" maxlength="50"
					styleClass="form-control" />
				<BR>
				<br>
				...
				<br>
				<html:text readonly="true" name="updateC" property="city" size="20" maxlength="20"
					styleClass="form-control" />
				<BR>
				<br>
				...
				<br>
				<html:text readonly="true" name="updateC" property="zip" size="20" maxlength="20"
					styleClass="form-control" />
				<BR>
				<br>
				...
				<br>
				<html:text readonly="true" name="updateC" property="country" size="20"
					maxlength="20" styleClass="form-control" />
		...
		<!-- here -->
			...
			<div class="col-md-4">
				...
				<br>
				<html:text readonly="true" styleId="pn1" name="updateC" property="phoneNumber1" size="20" 
					maxlength="20" styleClass="form-control" />
			</div>
			...
			<div class="col-md-4">
				...
				<br>
				 <html:select disabled="true" styleId="pk1" name="updateC" property="phoneKind1"  size="3" styleClass="form-control">
		...
		<div id="phone2" class="row">
			...
			<div class="col-md-4">
				...
				<span style="color: red"><html:errors property="phone number" /></span>
				<br>
				<html:text readonly="true" styleId="pn2" name="updateC" property="phoneNumber2" size="20" 
					maxlength="20" styleClass="form-control" />
			</div>
			...
			<div class="col-md-4">
				...
				<span style="color: red"><html:errors property="phone kind" /></span>
				<br>
				 <html:select disabled="true" styleId="pk2" name="updateC"  property="phoneKind2"  size="3" styleClass="form-control">
              		<html:option value="Home"><bean:message key="label.contact.phoneKind.Home" /></html:option>
					<html:option value="Work"><bean:message key="label.contact.phoneKind.Work" /></html:option>
				    <html:option value="Mobile"><bean:message key="label.contact.phoneKind.Mobile" /></html:option>
            </html:select>
		...
		<div id="phone3" class="row">
			...
			<div class="col-md-4">
				...
				<span style="color: red"><html:errors property="phone number" /></span>
				<br>
				<html:text readonly="true" styleId="pn3" name="updateC" property="phoneNumber3" size="20" 
					maxlength="20" styleClass="form-control" />
			</div>
			...
			<div class="col-md-4">
				...
				<span style="color: red"><html:errors property="phone kind" /></span>
				<br>
				 <html:select  disabled="true" styleId="pk3" name="updateC" property="phoneKind3"  size="3" styleClass="form-control">
              		<html:option value="Home"><bean:message key="label.contact.phoneKind.Home" /></html:option>
					<html:option value="Work"><bean:message key="label.contact.phoneKind.Work" /></html:option>
				    <html:option value="Mobile"><bean:message key="label.contact.phoneKind.Mobile" /></html:option>
            </html:select>
